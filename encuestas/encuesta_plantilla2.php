<form action="evaluar.php" method="post">
	...
	<p class="pregunta">¿Tiene capacidad y recursos como realizador/editor/dirección?</p>
	...
	<p class="pregunta">¿Tiene buen c​​onocimiento y manejo de su equipo​?</p>
	...
	<p class="pregunta">¿Tiene buena capacidad en la resolución de problemas técnicos​?</p>
	...
	<br>
	<input type="submit" class="btn btn-primary" name="encuestaPlantilla2Submit" value="Enviar">
</form>